...
// const LeadStatus = lazy(() => import('../pages/leadStatus/LeadStatus'));
// const ProductList = lazy(() => import('../pages/products/ProductList'));
// const SubProductList = lazy(() => import('../pages/subproducts/SubProductList'));
// const CustomerDetails = lazy (() => import('../pages/customers/CustomerDetails'));
// const BonusList = lazy (() => import('../pages/bonus/BonusList'));
// const FPDetailsList = lazy(() => import('../pages/fpdetails/FPDetailsList'));
// const FPDetails = lazy(() => import('../pages/fpdetails/FPDetails'));
...
// const SweetAlert = lazy(() => import('../pages/npComponents/SweetAlert'));
...
const routes = [
    ...
    // {
    //     path: '/fpDetailsList',
    //     element: <FPDetailsList />, // Add FPDetails route
    // },
    // {
    //     path: '/fpDetails/:id',
    //     element: <FPDetails />,
    ...
    {
        path: '/clientList', // Add ClientList route
        element: <ClientList />,
    },
    {
        path: '/Appointment',
