...
const UserRoleMappingListinfo = ({ apiUrl }) => {
    ...
    const handleCreateUserRoleMapping = async () => {
      try {
        ...
        const response = await userRoleMappingService.createUserRoleMapping(newUserRoleMapping);
    ...
    const fetchData = async () => {
      try {
        ...
        setNewUserRoleMapping(response.data);
      } catch (error) {
    ...
    const handleUpdateUserRoleMapping = async () => {
      try {
        ...
        const response = await userRoleMappingService.updateUserRoleMapping(newUserRoleMapping.id, newUserRoleMapping);
